...
void Quad::Initialize()
{
	...
	pTexture_->Load("Assets\\school.jpg");
}
...
void Quad::Draw(Transform transform)
{
	...
	CONSTANT_BUFFER cb;
	cb.matWVP = XMMatrixTranspose(transform.GetWorldMatrix() * Camera::GetViewMatrix()* Camera::GetProjectionMatrix()); //メインから受け取ったworldMatrixに移動行列と回転行列をかけている
